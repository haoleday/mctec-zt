<!--
 * @Author: your name
 * @Date: 2020-09-27 20:56:45
 * @LastEditTime: 2020-09-27 22:15:28
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \zt\src\views\layout\pageview.vue
-->
<template>
<div class="wrap" :style="{transform: 'scale('+scale+') translate(-50%, -50%)'}">
    <router-view />
</div>
</template>
